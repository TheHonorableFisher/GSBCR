...
namespace GSBCR.modele
{
    ...
    public partial class GSB_visite_groupe1Entities : DbContext
    {
        public GSB_visite_groupe1Entities()
            : base("name=GSB_visite_groupe1Entities")
        {
        }
        ...
        public virtual int addTravailler(string pMat, Nullable<System.DateTime> pDatAff, string pReg, string pRole)
        {
            var pMatParameter = pMat != null ?
                new ObjectParameter("pMat", pMat) :
                new ObjectParameter("pMat", typeof(string));
    
            var pDatAffParameter = pDatAff.HasValue ?
                new ObjectParameter("pDatAff", pDatAff) :
                new ObjectParameter("pDatAff", typeof(System.DateTime));
    
            var pRegParameter = pReg != null ?
                new ObjectParameter("pReg", pReg) :
                new ObjectParameter("pReg", typeof(string));
    
            var pRoleParameter = pRole != null ?
                new ObjectParameter("pRole", pRole) :
                new ObjectParameter("pRole", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("addTravailler", pMatParameter, pDatAffParameter, pRegParameter, pRoleParameter);
        }
